...
import "./NFTInuMath.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721.sol";

contract NFTInu is NFTInuStorage, NFTInuMath {
    ...
    function returnNFT(uint256 listingId) public {
        ...
        uint256 interestAmount = NFTInuMath._calculateInterest(_getListingById(listingId), elapsedRentalTime);
